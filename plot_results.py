...
def plot(fig, x_values, y_values, title="", x_label="", y_label="", line_label="", color='blue'):
    fig.set_title(title)
    ...
    try:
        ...
        ys=model(xs)
        fig.plot(xs, ys, label=line_label, color=color)
    except:
        fig.plot(x_group, y_group, label=line_label, color=color)
...
def plot_times(fig, algorithms, data):
    for a in algorithms:
        ...
        plot(fig, x, y, 'Execution time\n(seconds)', 'Iterations', 'Time (s)', a, color=algorithms[a])
...
def plot_nodes_evaluated(fig, algorithms, data):
    for a in algorithms:
        ...
        plot(fig, x, y, 'Total iterations executed\n(Total nodes evaluated)', 'Iterations', 'Nodes', a, color=algorithms[a])
...
def plot_algorithm_steps(fig, algorithms, data):
    for a in algorithms:
        ...
        plot(fig, x, y, 'Number of algorithm steps\n(Number of decisions)', 'Iterations', 'Steps', a, color=algorithms[a])
