...
def main(input_fm_name, run, iterations, exploration_weight):
    print("Problem 1 (deployed): Finding defective configurations.")
    print("-----------------------------------------------")
    ...
    initial_state = DefectiveDeployedConfigurationState(configuration=initial_config, data=problem_data)
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Problem 1 (deployed): Finding defective configurations.')
